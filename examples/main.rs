...
pub fn write_struct<'a, T: ConstWriterAdapter>(writer: ConstWriter<T, 10>) -> ConstWriter<T, 0> {
...
fn main() {
    ...
    let writer: ConstWriter<SliceWriterAdapter<'_, '_>, 20> = ref_buff.const_writer::<20>();
